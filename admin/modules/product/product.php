...
echo $total_rows= mysqli_num_rows(mysqli_query($connect,"SELECT * FROM product")); // lấy ra tổng số sản phẩm từ csdl
                    ...
                    <table data-toolbar="#toolbar" data-toggle="table">
                        ...
                        ?>
                            <tr>
                                ...
                                <td style=""><?=number_format($row['prd_price']) ?> vnđ</td>
                                ...
                                <td class="form-group">
                                    ...
                                    <a href="modules/product/del_product.php?prd_id=<?=$row['prd_id']?>" class="btn btn-danger" onclick="return confirm('Bạn có muốn xóa sản phẩm này không ?');"><i class="glyphicon glyphicon-remove"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>

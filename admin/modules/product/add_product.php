...
if (isset($_POST['sbm'])) {
    ...
    $sql = "INSERT INTO product (prd_name,prd_price,prd_warranty,prd_accessories,prd_promotion,prd_new,prd_image,cat_id,prd_status,prd_featured,prd_details) VALUE ('$prd_name','$prd_price','$prd_warranty','$prd_accessories','$prd_promotion','$prd_new','$prd_image',$cat_id,$prd_status,$prd_featured,'$prd_details')";
...
<!--/.main-->
 <!-- sử dụng file reader để dọc dữ liệu tạm trước khi upload lên csdl , hiển thị hình ảnh xem trc -->
<script>

									 ...
									 ?>
										<tr>
											...
											<td class="form-group">
												...
												<a href="modules/category/del_category.php?cat_id=<?=$row['cat_id']?>" class="btn btn-danger" onclick="return confirm('Bạn có muốn xóa danh mục này không ?');"><i class="glyphicon glyphicon-remove"></i></a>
											</td>
										</tr>
										<?php } ?>

...
$sql_page = "SELECT * FROM comment WHERE prd_id = $prd_id ORDER BY comm_id DESC";
...
<div id="product">
    ...
    if(isset($_POST['sbm'])){
        ...
        $sql_insertcomm = "INSERT INTO comment (prd_id,comm_name,comm_mail,comm_date,comm_details) VALUE ($prd_id,'$comm_name','$comm_mail','$comm_date','$comm_details')";
        mysqli_query($connect,$sql_insertcomm);
    }
